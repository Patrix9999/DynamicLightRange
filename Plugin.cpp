...
namespace GOTHIC_ENGINE {
    ...
    HOOK Hook_zCVobLightData_Unarchive AS(&zCVobLightData::Unarchive, &zCVobLightData::Hook_Unarchive);
    void zCVobLightData::Hook_Unarchive(zCArchiver& arc)
    {
        THISCALL(Hook_zCVobLightData_Unarchive)(arc);
    ...
    HOOK Hook_zCVobLight_DoAnimation AS(&zCVobLight::DoAnimation, &zCVobLight::Hook_DoAnimation);
    void zCVobLight::Hook_DoAnimation()
    {
        ...
        THISCALL(Hook_zCVobLight_DoAnimation)();
    }
